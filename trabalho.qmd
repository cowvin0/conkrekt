...
Aqui podemos ver o intervalo de confiança para os coeficientes de regressão, que nos permitem entender o impacto médio causado na força compressiva do concreto por cada uma variável regressora. Por exemplo, para cada $kg$ de cimento em uma mistura de $m_3$ há um aumento médio na força compressiva do concreto entre 0.742 e 0.795. 
